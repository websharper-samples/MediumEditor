...
{
 "use strict";
 var Global,Samples,HelloWorld,WebSharper,Operators,Obj,UI,Doc,Elt,Arrays,Templating,Runtime,Server,TemplateInstance,ProviderBuilder,Var,Handler,MediumEditor_Templates,Var$1,JavaScript,Pervasives,Collections,List,Unchecked,System,Guid,SC$1,View,Array,EventTarget,Docs,AttrProxy,Dictionary,HashSet,Client,Seq,Client$1,Templates,Updates,Node,DocElemNode,Object,Snap,JS,Attrs,Abbrev,Fresh,DictionaryUtil,Enumerator,T,ConcreteVar,CheckedInput,Numeric,DomUtility,CharacterData,Attrs$1,Dyn,SC$2,SC$3,WindowOrWorkerGlobalScope,SC$4,SC$5,Prepare,Slice,KeyCollection,An,Settings,Mailbox,HashSetUtil,AttrModule,List$1,T$1,Strings,Docs$1,RunState,NodeSet,Anims,SC$6,String,SC$7,Concurrency,AppendList,Char,DynamicAttrNode,Easing,AsyncBody,SC$8,CT,HashSet$1,Queue,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,$,Math,console,Date;
 Global=self;
 ...
 MediumEditor_Templates=Global.MediumEditor_Templates=Global.MediumEditor_Templates||{};
 ...
 SC$1=Global.StartupCode$MediumEditor$Client=Global.StartupCode$MediumEditor$Client||{};
 ...
 {
  var a,b,P,p,i;
  a=(b=(P=Doc.BindView(Doc.Verbatim,HelloWorld.editedText().get_View()),ProviderBuilder.Make().WithHole({
   $:0,
   $0:"preview",
   $1:P
  })),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],MediumEditor_Templates.main(p[0])),(b.i=i,i)))).get_Doc().OnAfterRender(function()
  {
   new Global.MediumEditor(".editable");
   Global.jQuery(".medium-editor-element").keyup(function()
   {
    return Var$1.Set(HelloWorld.editedText(),Global.jQuery("#formatted").val());
   });
   Global.jQuery(".medium-editor-element").on("input",function()
   {
    return Var$1.Set(HelloWorld.editedText(),Global.jQuery("#formatted").val());
   });
  });
 ...
 HelloWorld.editedText=function()
 {
  SC$1.$cctor();
  return SC$1.editedText;
 };
 ...
 Elt=UI.Elt=Runtime$1.Class({
  ...
  "OnAfterRender'":function(cb)
  {
   ...
   m=this.docNode$1;
   m!=null&&m.$==1?(e=m.$0,Runtime$1.SetOptional(e,"Render",(m$1=Runtime$1.GetOptional(e.Render),m$1!=null&&m$1.$==1?(f=m$1.$0,{
    $:1,
    $0:function(el)
    {
     f(el);
    ...
    $:1,
    $0:cb
   }))):m!=null&&m.$==6?(e$1=m.$0,Runtime$1.SetOptional(e$1,"Render",(m$2=Runtime$1.GetOptional(e$1.Render),m$2!=null&&m$2.$==1?(f$1=m$2.$0,{
    $:1,
    $0:function(el)
    {
     f$1(el);
 ...
 MediumEditor_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.editedText=Var$1.Create$1("Hello blogger!");
 };
